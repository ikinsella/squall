...
if __name__ == "__main__":
    ...
    if spark_home_loose_version >= LooseVersion("1.2.0"):
        ...
        parser.add_option("--additional-tags", type="string", default="",  # Modified 10/02/15
    ...
    parser.add_option("--private-ips", action="store_true", default=False,
                      ...
                      "requires that.")
    parser.add_option(  # modified 10/02/2015
        "--instance-initiated-shutdown-behavior", default="stop",
        choices=["stop", "terminate"],
        help="Whether instances should terminate when shut down or just stop")
    parser.add_option("--instance-profile-name",  # Modified 10/02/2015
                      default=None,help="IAM profile name to launch instances under")
